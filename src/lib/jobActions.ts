 ...
 * Cancel and Discard are deliberately unavailable in every state: v2.9.0 cannot
 ...
 * unavailable because v2.9.0 does not rebuild a child's dependency registration.
 *
 * Active state transitions are deliberately absent. Bunqueue v2.9.0 removes
