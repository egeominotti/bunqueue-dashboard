 ...
 * Cancel and Discard are deliberately unavailable in every state: v2.8.59 cannot
 ...
 * unavailable because v2.8.59 does not rebuild a child's dependency registration.
 *
 * Active state transitions are deliberately absent. Bunqueue v2.8.59 removes
