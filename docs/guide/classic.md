---
title: Classic pages
description: "The first-generation classic view pages, kept intact per the additive rule, and how each maps to its Pro replacement."
---
...
disabled by the v2.8.57 atomicity policy.
