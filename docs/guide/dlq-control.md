---
title: DLQ Control
description: "Pick one queue to inspect and export failed jobs; all retry and purge mutations fail closed under the v2.8.57 contract."
---

# DLQ Control

Pick one queue to inspect and export the jobs that failed for good. All row,
bulk and queue-wide retry mutations are unavailable under the v2.8.57
fail-closed policy.
...
removed and a new job created under the same ID. Bunqueue v2.8.57 gives the POST
